...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        ...
        const selecaoPersonages = document.querySelector('.selecionado');
        selecaoPersonages.classList.remove('selecionado');
        ...
        const nomePersonagems = document.getElementById('nome-personagem');
        nomePersonagems.innerText = personagem.getAttribute('data-nome')
